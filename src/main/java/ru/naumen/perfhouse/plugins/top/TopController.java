...
public class TopController extends HistoryController
{
    ...
    {
        return getDataAndViewByDate(client, new TopDataType(), year, month, day, CPU_VIEW);
    }
    ...
    {
        return getDataAndViewByDate(client, new TopDataType(), year, month, 0, CPU_VIEW, true);
    }
    ...
    {
        return getDataAndView(client, new TopDataType(), count, CPU_VIEW);
    }
    ...
    {
        return getDataAndViewCustom(client, new TopDataType(), from, to, count, CPU_VIEW);
    }
}
